...
$mensagem = match(true) {
    $idade >= 18 => "Você tem $idade anos. Pode entrar no estabelecimento.",
    ...
    default => "Você tem $idade anos. Desculpe, você só pode entrar no estabelecimento com um acompanhante.",
};
